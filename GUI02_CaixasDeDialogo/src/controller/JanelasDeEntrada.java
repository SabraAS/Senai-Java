...
public class JanelasDeEntrada {
	...
	public static void main(String[] args) {
		...
		String texto2 = JOptionPane.showInputDialog("Janela de Entrada 2");
		...
		String texto4 = JOptionPane.showInputDialog("Janela de Entrada 4","Valor inicial da janela de entrada 4");
		...
		ImageIcon iconFoto = new ImageIcon("img/ic_onoff.jpg");
