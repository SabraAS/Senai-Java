...
public class InfoNote {
	...
	public void cadastrarNotebook() {
		...
		String modelo = Teclado.lerTexto("informe o modelo do notebook "+"para compra  ");
	...
	public void manterCarrinho(int operacao) {
		...
		public void VerCarrinho() {
			...
			public void removerCarrinho() {
				String modelo = Teclado.lerTexto("Informe o modelo do notebook" + "para remover do carrinho: ");
